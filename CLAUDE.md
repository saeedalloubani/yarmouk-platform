...
`docs/STATUS.md` has the session-by-session build status. `docs/DECISIONS.md` has the full decision history (D1-D54). `docs/CONVENTIONS.md` has the conventions. `RUNBOOK.md` has manual ops (Vault key lifecycle).
