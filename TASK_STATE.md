...
Last updated: admin dashboard + sidebar shell (2026-05-21); Session 3 complete, dashboard live.
...
│   └── AdminShell.tsx                 Client sidebar shell — role-gated nav (Questionnaires owner-only) (dashboard)
├── lib/
